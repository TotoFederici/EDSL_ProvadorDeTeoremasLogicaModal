...
- Utilización del demostrador:
    ...
    En el directorio 'EDSL-ModalLogic' correr el comando 'stack run', esto automaticamente lanzará     una interfaz interactiva, Elegir:
        ...
        2) Un sistema de carga de archivos, estos deben estar en el directorio 'examples' y pueden contener una formula por linea, se pueden utilizar todos los saltos de linea que sean necesarios. El programa mostrará el resultado de intentar demostrar las formulas del archivo en orden.
